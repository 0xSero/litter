...
- Build economy: share one Cargo target cache across mission worktrees, use focused filters during implementation, and reserve expensive full suites for the combined wave validator or one explicitly named final task gate.
